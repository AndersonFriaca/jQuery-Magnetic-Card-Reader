  ...
  $.extend(MagneticCardReader.prototype, {
    ...
    watchCompleted: function() {
      ...
      this.element.on(this.generateEventName('completed'), function(
        ...
        if (
          captured.firstTrail !== null &&
          self.options.buildDataFirstTrail !== null
        ) {
          dataFirstTrail = self.options.buildDataFirstTrail(
            captured.firstTrail
          );
        }
        if (
          captured.secondTrail !== null &&
          self.options.buildDataSecondTrail !== null
        ) {
          dataSecondTrail = self.options.buildDataSecondTrail(
            captured.secondTrail
          );
        }
        if (
          captured.thirdTrail !== null &&
          self.options.buildDataThirdTrail !== null
        ) {
          dataThirdTrail = self.options.buildDataThirdTrail(
            captured.thirdTrail
          );
        }
